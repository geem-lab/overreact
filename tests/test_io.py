...
def test_parse_model_raises_filenotfounderror() -> None:
...
def test_compare_rrho_with_orca_logfile() -> None:
...
def test_compare_qrrho_with_orca_logfile() -> None:
...
def test_read_logfile_from_orca_xtb() -> None:
