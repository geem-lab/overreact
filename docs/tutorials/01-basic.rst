Basic usage: a Michaelis-Menten model
=====================================
...
>>> scheme = core.parse("E + S <=> ES -> ES* -> E + P")
...
One return value that ``core.parse`` has given us was the :math:`A`
...
>>> tof = dy[scheme.compounds.index("P")] / (y[scheme.compounds.index("E"), :] + y[scheme.compounds.index("ES"), :])
>>> plt.clf()
